...
COMMANDS = [
    "v5/run_suites.sh                                    # 13,824행 본 행렬 + drift 5종",
    "python3 v5/holdout.py --seeds 3 --calls 12          # 공개 스키마 hold-out",
    "runtime/mcp-sdk-venv/bin/python v5/real_mcp.py --repeats 12   # 공식 MCP SDK",
    "python3 v5/llm_layer.py --models qwen3:4b qwen2.5:7b gemma3:4b gemma4:12b --calls 3",
    ...
    "python3 -m pytest tests/test_v5.py                  # 회귀 테스트",
    "python3 v5/make_paper.py && python3 v5/make_report.py",
]
...
def main() -> None:
    ...
    release = {
        ...
        "python": subprocess.run(["python3", "--version"], capture_output=True,
